...
---[ end trace 3c2d7d6e4ee91528 ]---

It looks like the message above is occuring due to a pointer issue below:

"Unable to handle kernel NULL pointer dereference at virtual address 0000000000000000"

it appears we are trying to write to a null pointer and this happened in the "pc : faulty_write+0x10/0x20 [faulty]" function.

also, the call trace shows this occured in "faulty_write+0x10/0x20 [faulty]"
